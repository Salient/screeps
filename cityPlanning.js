...
module.exports.planRoom = function(room) {
    ...
    // Priorities 
    //  1, extensions, 
    //  2, ramparts around base perimeter, and 
    //  3  walls around exits
...
function placeExtensions(room) {
    ...
    // to spawn first
    if (!util.def(room.memory.paths) || !util.def(room.memory.paths.sources) ) {return}
